...
import com.example.floatingtimer.databinding.TimerItemBinding


class TimerItem @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null): LinearLayout(context, attributeSet) {
    private val binding = TimerItemBinding.inflate(LayoutInflater.from(context), this, true)
